...
-- m3 = fromLists [[1, 2, 3, 4], [4, 3, 2, 1], [-1, -2, -3, -4], [-4, -3, -2, 7]]
-- v3 = fromLists [[12, 11, -11, -1]]
-- w3 = fromLists [[1, 3, 5, 7]]
-- n3 = 4

m4 = fromLists [[1, 0, 3, 1, 4], [0, 3, 0, 1, 5], [0, -2, 3, 0, 6], [4, 0, 0, 7, 7], [1, 2, 3, 4, 5]]
v4 = fromLists [[1, 2, 3, -4, 5]]
w4 = fromLists [[3, 2, 1, 4, -1]]
n4 = 5
...
toPlay = chord . map (line . take 500)  $ [musics v4 w4 m4 n4, musics v2 w2 m2 n2, musics v0 w0 m0 n0]
